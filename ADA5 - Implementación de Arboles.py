...
def menu():
    ...
    while True:
        ...
        print("[2] Mostrar árbol completo visualmente")
        ...
        print("[7] Recorrer el árbol por niveles")
        print("[8] Altura del árbol")
        print("[9] Cantidad de hojas")
        print("[10] Cantidad de nodos")
        print("[11] Verificar si es un árbol completo")
        print("[12] Verificar si es un árbol lleno")
        print("[13] Eliminar el árbol")
        print("[14] Salir")
        ...
        if opcion == 14:
            ...
            print("Árbol mostrado visualmente:")
